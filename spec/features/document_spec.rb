...
describe "documents function as expected", js: true, type: :feature do
  ...
  it "documents have some tabs" do
    ...
    DocumentInference.new(
      document_id: doc.id,
      inference_type: "summary",
      inference_value: '"A lovely example of accessible PDF practices."',
      inference_model_name: "gemini-friend"
    ).save
    ...
    within("#document-list .modal") do
      ...
      expect(page).to have_content("Generated by gemini-friend")
    ...
    within("#document-list .modal") do
      ...
      expect(page).to have_no_content("Old archival value")
      ...
      expect(page).to have_content("Archived web content: Yes, but clearly mark as archived\nThis thing was made in 1988 and hasn't been opened since then.")
      expect(page).to have_content("Generated by anthropic-friend")
      find(".close").click
    end
  end
  ...
  it "exports documents" do
    ...
    assert_match "sites/#{site.id}/documents/audit_exports", current_url, wait: 5
