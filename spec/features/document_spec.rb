...
describe "documents function as expected", js: true, type: :feature do
  ...
  it "documents have some tabs" do
    ...
    within("#document-list .modal") do
      ...
      expect(page).to have_no_content "This suggestion information was generated by a Large Language Model and while highly reliable, should still be subjected to careful verification."
    end
    # Add some inferences.
    ...
    within("#document-list .modal") do
      ...
      expect(page).to have_content("This suggestion information was generated by a Large Language Model and while highly reliable, should still be subjected to careful verification.")
